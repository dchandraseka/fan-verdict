-- FanVerdict FIFA 2026 Round of 32 remaining poll creation.
...
-- This file loads the 7 Round of 32 fixtures not included in
-- create-fifa-2026-round-of-32-confirmed.sql.
--
...
create temporary table fanverdict_fifa_2026_r32_remaining_fixtures (
...
insert into fanverdict_fifa_2026_r32_remaining_fixtures (
  game_number,
  fifa_match_number,
  team_a,
  team_b,
...
values
  (79, 79, 'Mexico', 'Ecuador', '2026-07-01 01:00:00+00'::timestamptz, 'Mexico City Stadium, Mexico City'),
  (80, 80, 'England', 'Congo DR', '2026-07-01 16:00:00+00'::timestamptz, 'Atlanta Stadium, Atlanta'),
  (81, 82, 'Belgium', 'Senegal', '2026-07-01 20:00:00+00'::timestamptz, 'Seattle Stadium, Seattle'),
  (83, 84, 'Spain', 'Austria', '2026-07-02 19:00:00+00'::timestamptz, 'Los Angeles Stadium, Los Angeles'),
  (84, 83, 'Portugal', 'Croatia', '2026-07-02 23:00:00+00'::timestamptz, 'Toronto Stadium, Toronto'),
  (85, 85, 'Switzerland', 'Algeria', '2026-07-03 03:00:00+00'::timestamptz, 'BC Place Vancouver, Vancouver'),
  (88, 87, 'Colombia', 'Ghana', '2026-07-04 01:30:00+00'::timestamptz, 'Kansas City Stadium, Kansas City');
...
begin
  if exists (
    ...
    join fanverdict_fifa_2026_r32_remaining_fixtures f
...
from fanverdict_fifa_2026_r32_remaining_fixtures fixtures
...
with target_matches as (
  select
    ...
    f.team_b,
    f.starts_at
  from fanverdict_fifa_2026_r32_remaining_fixtures f
...
from public.matches m
join fanverdict_fifa_2026_r32_remaining_fixtures f on f.game_number = m.game_number
...
-- Verification: should return 7 rows, each with exactly two poll options.
select
  m.game_number,
  m.source_ref,
  m.team_a,
...
where m.tournament_id = 'a98200a3-8648-4589-ad47-e8866db1d0e2'::uuid
  and m.game_number in (79, 80, 81, 83, 84, 85, 88)
group by
  m.game_number,
  m.source_ref,
  m.team_a,
