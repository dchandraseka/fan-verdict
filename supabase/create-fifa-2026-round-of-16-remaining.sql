-- FanVerdict FIFA 2026 Round of 16 remaining poll creation.
...
-- This file loads the 2 Round of 16 fixtures not included in
-- create-fifa-2026-round-of-16-confirmed.sql.
--
...
create temporary table fanverdict_fifa_2026_r16_remaining_fixtures (
...
insert into fanverdict_fifa_2026_r16_remaining_fixtures (
  game_number,
  fifa_match_number,
  team_a,
  team_b,
...
values
  (95, 95, 'Argentina', 'Egypt', '2026-07-07 16:00:00+00'::timestamptz, 'Atlanta Stadium, Atlanta'),
  (96, 96, 'Switzerland', 'Colombia', '2026-07-07 20:00:00+00'::timestamptz, 'BC Place Vancouver, Vancouver');
...
begin
  if exists (
    ...
    join fanverdict_fifa_2026_r16_remaining_fixtures f
...
from fanverdict_fifa_2026_r16_remaining_fixtures fixtures
...
with target_matches as (
  select
    ...
    f.team_b,
    f.starts_at
  from fanverdict_fifa_2026_r16_remaining_fixtures f
...
from public.matches m
join fanverdict_fifa_2026_r16_remaining_fixtures f on f.game_number = m.game_number
...
-- Verification: should return 2 rows, each with exactly two poll options.
select
  m.game_number,
  m.source_ref,
  m.team_a,
